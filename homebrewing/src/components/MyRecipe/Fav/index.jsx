...
export default function Fav({ favUpdated }) {
    ...
    if (favourites.length > 0) {
            ...
            <li key={index}>
              ...
              <div className="btnContainer">
                <button
                  onClick={() => {
                    navigate(
                      `/menu/${favourite.menuName}/method/${favourite.methodName}/recipe/${favourite.water}/${favourite.coffee}/${favourite.roasting}/${favourite.grind}/brewing`
                    );
                  }}
                >
                  Go Brew
      ...
      return (
        <div className="noneFav">
          <Link className="makeFavBtn" to={"/menu"}>
            Make Your Favourite Brews!
          </Link>
        </div>
      );
    }
    ...
    if (customFav === "detail") {
      return (
        <div className="detailCustomSetting">
          ...
          <p
            onClick={() => {
              setCustomDetail("menuName");
            }}
          >
            Coffee: {favList.menuName}
          </p>
          <p
            onClick={() => {
              setCustomDetail("methodName");
            }}
          >
            Method: {favList.methodName}
          </p>
          <p
            onClick={() => {
              setCustomDetail("water");
            }}
          >
            Water: {favList.water}
          </p>
          <p
            onClick={() => {
              setCustomDetail("coffee");
            }}
          >
            Ground Coffee: {favList.coffee}g
          </p>
          <p
            onClick={() => {
              setCustomDetail("roasting");
            }}
          >
            Roasting Level: {favList.roasting}
          </p>
          <p
            onClick={() => {
              setCustomDetail("grind");
            }}
          >
            Grind Size: {favList.grind}
          </p>
        </div>
      );
  ...
  const settingCustom = () => {
    if (customFav === "") {
      ...
      return <div className="customContainer">{settingCustomDetail()}</div>;
        ...
        <div className="customDetail">
          <div className="customfavName">
            ...
            <input
              type="text"
              onChange={(e) => {
                setFavNameUpdate(e.target.value);
              }}
            />
            <button
              onClick={() => {
      ...
      return (
        <div className="customDetail">
          <ul className="customMethodName">
            ...
            <li
              onMouseEnter={() => {
                setMethodNameUpdate("frenchPress");
              }}
              onClick={() => {
                updateFavMethod(favList, methodNameUpdate);
                setCustomDetail("");
          ...
          <div className="customCoffee">
            <div>
              ...
              <input
                type="text"
                onChange={(e) => {
                  setCoffeeUpdate(e.target.value);
                }}
              />
            </div>
            <button
    ...
    <div className="FavContainer">
      <div className="favTitle">
        <header>
          ...
          Your favourite brews.
        </header>
        <p>You can save maximum 5 favourite Brews.</p>
      </div>
      <div className="favContents">
        <div className="favourites">{settingFavourites()}</div>
        <div className="favDetailContainer">{settingFavDetails()}</div>
      </div>
    </div>
  );
}
